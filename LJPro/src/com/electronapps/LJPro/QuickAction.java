...
public class QuickAction extends CustomPopupWindow {
	...
	private void createActionList() {
		...
		for (int i = 0; i < actionList.size(); i++) {
			...
			pressed   	=actionList.get(i).isPressed();
			
	
			view 		= getActionItem(title, icon, listener,id,pressed);
	 ...
	 */
	private View getActionItem(String title, Drawable icon, OnClickListener listener,int id,Boolean pressed) {
