...
public class FPListAdapter extends CursorAdapter implements FilterQueryProvider{
    ...
    public FPListAdapter(Context context, String accountname, Cursor c, int layoutId) {
        super(context, c);
       this.mCursor=c;
