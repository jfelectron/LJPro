...
import com.zmosoft.flickrfree.GlobalResources;

import android.content.Context;
import android.content.Intent;
import android.util.Log;

public class FileEntityMonitored extends FileEntity {
	...
	public FileEntityMonitored(Context context, File file, String title,String ctype) {
		super(file,ctype);
		m_context = context;
		m_title = title;
		m_file=file.getPath();
